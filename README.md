# ðŸš€ CRM Agencia Marketing

<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=CRM-Agencia-Marketing&fontSize=40&fontColor=ffffff" />
</div>
...
Motor de gestão Fullstack voltado para agências de marketing.
...
1. FaÃ§a o clone do repositÃ³rio:
   `ash
   git clone https://github.com/Alysontrx/CRM-Agencia-Marketing.git
   `
2. Acesse o diretÃ³rio:
   `ash
   cd CRM-Agencia-Marketing
   `
